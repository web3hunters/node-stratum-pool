...
var pool = module.exports = function pool(options, authorizeFn) {
    ...
    function SubmitBlock(height, blockHex, callback) {
        ...
        if (options.hasSubmitMethod) {
            ...
            if (options.coin.pbaasActivationHeight && height >= options.coin.pbaasActivationHeight) {
                rpcCommand = 'submitmergedblock';
            }
            
            console.log("****** submit method", rpcCommand);
    ...
    function GetBlockTemplate(callback) {
        ...
        function getBlockTemplate(next_height, subsidy) {
            ...
            if (options.coin.pbaasActivationHeight && next_height >= options.coin.pbaasActivationHeight) {
                gbtFunction = "getmergedblocktemplate";
            }
